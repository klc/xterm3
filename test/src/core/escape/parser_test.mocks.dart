...
import 'package:xterm3/src/core/escape/handler.dart' as _i2;
import 'package:xterm3/src/core/mouse/mode.dart' as _i3;
...
class MockEscapeHandler extends _i1.Mock implements _i2.EscapeHandler {
  ...
  @override
  void resetTabStops() => super.noSuchMethod(
        Invocation.method(
          #resetTabStops,
          [],
        ),
  ...
  @override
  void sendColorScheme() => super.noSuchMethod(
        Invocation.method(
          #sendColorScheme,
          [],
        ),
  ...
  @override
  void sendStatusString(String? query) => super.noSuchMethod(
        Invocation.method(
          #sendStatusString,
          [query],
        ),
  ...
  @override
  void setCursorShape(int? style) => super.noSuchMethod(
        Invocation.method(
          #setCursorShape,
          [style],
        ),
  ...
  @override
  void setCurrentDirectory(String? uri) => super.noSuchMethod(
        Invocation.method(
          #setCurrentDirectory,
          [uri],
        ),
  ...
  @override
  void setHyperlink(String? params, String? uri) => super.noSuchMethod(
        Invocation.method(
          #setHyperlink,
          [params, uri],
        ),
